    ...
    public class BloodProductModel
    {
        ...
        public BloodProductModel()
        {
            this.bloodproducts = new List<BloodProduct>()
            {
                ...
                new BloodProduct{
                    Id = "PLTRD",
                    Name = "Platelets Concentrates from Random Donors, Unpooled",
                    Charge = 230,
                    Leucodeplete = 0,
                    Irradiate = 0,
                    Upperage = 99999,
                ...
                new BloodProduct{
                    Id = "PLTRD-HLA",
                    Name = "HLA-compatible Platelets Concentrates from Random Donors, Unpooled",
                    Charge = 230,
                    Leucodeplete = 1,
                    Irradiate = 1,
                    Upperage = 99999,
                ...
                new BloodProduct{
                    Id = "PLTPL-LD",
                    Name = "Random Donor Platelet Concentrates, Pooled, Leucodepleted",
                    Charge = 230,
                    Leucodeplete = 1,
                    Irradiate = 0,
                    Upperage = 99999,
                ...
                new BloodProduct{
                    Id = "PLLR",
                    Name = "Single Donor Apheresis Platelet Concentrates, Leucodepleted",
                    Charge = 230,
                    Leucodeplete = 1,
                    Irradiate = 0,
                    Upperage = 99999,
                ...
                new BloodProduct{
                    Id = "PLLR-HLA",
                    Name = "HLA-compatible Single Donor Apheresis Platelet Concentrates, Leucodepleted",
                    Charge = 230,
                    Leucodeplete = 1,
                    Irradiate = 1,
                    Upperage = 99999,
                ...
                new BloodProduct{
                    Id = "PLLR-PP",
                    Name = "Pedi-pack, Single Donor Apheresis Platelet Concentrates, Leucodepleted",
                    Charge = 230,
                    Leucodeplete = 1,
                    Irradiate = 0,
                    Upperage = 365,
                ...
                new BloodProduct{
                    Id = "PLLR-PP-HLA",
                    Name = "HLA-compatible Pedi-pack, Single Donor Apheresis Platelet Concentrates, Leucodepleted",
                    Charge = 230,
                    Leucodeplete = 1,
                    Irradiate = 1,
                    Upperage = 365,
